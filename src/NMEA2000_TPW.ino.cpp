# 1 "C:\\Users\\GERRYA~1\\AppData\\Local\\Temp\\tmp3u5tyora"
#include <Arduino.h>
...
void SendN2kWind(void){
  ...
  if (IsTimeToUpdate(SlowDataUpdated)){
    ...
    SetN2kPGN130306(N2kMsg, 0, dMWV_WindSpeed, dMWV_WindAngle, tN2kWindReference::N2kWind_Apparent);
...
void loop()
{
 ...
 {
    switch (WiFi.status()){
      case 0: LEDflash(LED(Blue)); break;
      case 3: LEDflash(LED(Green)); break;
      case 4:
      case 5:
